...
// };
  ...
  const uploadFile = async () => {
      ...
      try {
          const response = await axios.post('https://deen.somee.com/api/Dashboard/AddQuran', {
            File : file,
            Name : num
          }, {
              headers: {
  ...
  return ( 
    <div className='container'>
        ...
        <h3 className='py-3'>الورد اليومي</h3>
        <hr />
...
<input type="text" className='input-drop w-100' placeholder='اكتب اسم الورد اليومي هنا' onChange={(e) => setNum(e.target.value)}/>
