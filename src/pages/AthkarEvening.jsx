...
export default function AthkarEvening() {
    ...
    const apiClient = axios.create({
      ...
      const getUsers = async () => {
        try {
          const response = await apiClient.get('/api/Dashboard/GetAllAthkarEvening'); // Replace with your endpoint
        ...
        <div className="d-flex position-relative  gap-3">
         ...
         <div className="rigth-section my-5 w-100 mr-16 px-5">
              <div className="d-flex align-items-center justify-content-between">
                <h3>اذكار المساء</h3>
                 <Link to='/upload222'><button className='btn-add'>اضافة ذكر</button></Link>
              </div>
